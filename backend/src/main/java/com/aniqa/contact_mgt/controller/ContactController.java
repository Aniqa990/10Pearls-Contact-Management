...
public class ContactController {
    ...
    public ResponseEntity<ContactDTO> updateContact(@PathVariable String contactId, @PathVariable String userId ,@RequestBody ContactDTO dto) {
        return ResponseEntity.ok().body(contactService.updateContact(contactId, userId,  dto));
    }
